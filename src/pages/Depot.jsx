...
export default function Depot() {
    ...
    // NOUVEL ÉTAT : Pour gérer l'affichage du Modal
    ...
    const handleSubmit = async (e) => {
        ...
        if (!file) {
            alert("Attention : Vous devez sélectionner une image pour le plan !");
            return;
        }
        ...
        try {
            ...
            if (error.response) {
                ...
                alert(`X Erreur Backend (${error.response.status}) :\n${msg}\n\n${details}`);
            } else if (error.request) {
                alert("X Erreur Réseau : Le serveur ne répond pas.");
            } else {
                alert("X Erreur Client : " + error.message);
            }
    ...
    return (
        <div className="main-content">
            ...
            {/* LE MODAL (S'affiche uniquement si isSubmitting est true) */}
            {isSubmitting && (
